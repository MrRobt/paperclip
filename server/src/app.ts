...
import { legionGoalRoutes } from "./routes/legion.goals.js";
import { legionTaskRoutes } from "./routes/legion.tasks.js";
import { legionMonitorRoutes } from "./routes/legion.monitor.js";
...
export async function createApp(
  ...
  api.use(legionGoalRoutes(db));
  api.use(legionTaskRoutes(db));
  api.use(legionMonitorRoutes(db));
